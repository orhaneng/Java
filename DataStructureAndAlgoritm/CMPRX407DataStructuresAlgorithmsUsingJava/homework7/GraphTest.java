...
/**
 * File Name: GraphTest.java Tests Graph object
 * 
	...
	private void testDFS() {
		{
			...
			for (int i = 0; i < nl; ++i) {
				...
				// sc- starting city/ we should return cycle or no, dsforder array, size array
				// size.
...
//			double[] w = { 13 };
	...
	private void testBed() {
		...
		// testDFS();
		/*
		 * testBFS() ; /* testToplogicalSort() ; testDagLongestPath() ;
		 * 
		 * 
		 * testDPShortestPath() ; testBF() ; testTSP() ; testPrim() ;
		 */
	}
