...
import org.orhan.javabrains.messenger.resources.beans.MessageFilterBean;
import org.orhan.javabrains.messenger.service.MessageService;
...
public class MessageResource {
	...
	public List<Message> getMessages(@BeanParam MessageFilterBean filterBean) {
		...
		if (filterBean.getStart() >= 0 && filterBean.getSize() >= 0)
			return messageService.getAllMessagesForPaginated(filterBean.getStart(), filterBean.getSize());
